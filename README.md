...
- **文献管理** — 支持手动添加与选择性导入，入库前由用户确认，自动生成结构化分析文档，保留独立人工笔记空间
- **每日推送** — 定时抓取 `Arxiv` 最新论文，自动评分，快速筛选入库
- **数据集管理** — 独立数据集档案，与论文形成关联，支持实验结果横向对比
- **Zotero 集成** — 通过 `Zotero MCP` 读取现有文献库与 Collection，支持导入与关联
- **观点提炼** — 从文献中抽取关键观点，形成可查询的知识库
- **科研进展追踪（课题管理）** — 以 Overview / Related Work / Method / Experiment / Conclusion / Manuscript 六模块管理课题全生命周期
